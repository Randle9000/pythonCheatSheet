#So far we used functions as decorators.
# Before we can define a decorator as a class,
...
# We can define classes as callable objects as well. The __call__ method is called,
# if the instance is called "like a function", i.e. using brackets.
